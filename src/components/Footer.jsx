 ...
 <div class="flex items-end w-full   bg-white">
    ...
    <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <Link
                    to="/"
                    className="flex text-black gap-3 justify-center md:justify-start font-bold text-lg"
                  >
                    <img
                ...
                <p class="mt-2 text-sm text-gray-500">Design, Quality and Ship!</p>
                <div class="mt-4">
        ...
        <div class="bg-gray-300">
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-gray-700 capitalize lg:text-left text-center">© 2020 All rights reserved </p>
            </div>
        </div>
    </footer>
